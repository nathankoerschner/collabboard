...
import type { AICommandResponse, Point } from '../../../shared/types.js';
...
function safeJsonParse(raw: string | undefined | null, fallback: Record<string, unknown> = {}): Record<string, unknown> {
...
export async function executeBoardAICommand({ boardId, prompt, viewportCenter, userId }: {
  ...
  return {
    ...
    updatedIds: mutationSummary.updatedIds,
    deletedIds: mutationSummary.deletedIds,
    toolCalls: mutationSummary.toolCalls,
    durationMs,
    completed,
    errors,
  };
